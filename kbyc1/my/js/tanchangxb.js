	...
	MobileArea.prototype = {
		...
		bindEvent: function() {
			...
			function popupArea(e) {
				...
				_self.gearArea.innerHTML = '<div class="area_ctrl slideInUp" style="height:250px;">' +
					'<div class="area_btn_box">' +
					'<div class="area_btn larea_cancel">取消</div>' +
					'<div class="area_btn larea_finish">确定</div>' +
					'</div>' +
					'<div class="area_roll_mask">' +
					'<div class="area_roll" style="color:#111;height: 250px;">' +
		...
		finish: function(e) {
			...
			_self.trigger.innerHTML = provinceText;
